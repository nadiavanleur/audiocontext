...
class Kick {
  ...
  trigger = ({
    ...
    this.osc.frequency.setValueAtTime(this.frequency, start);
  ...
  play = ({
    ...
    console.info(`Playing kick ${this.name} ${actualIterations} times for ${secondsToHHMMSS(trackDuration || iterations*interval*2)} at an interval of ${interval}s`);
  }
}
